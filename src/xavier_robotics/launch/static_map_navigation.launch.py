...
# STATIC MAP NAVIGATION LAUNCH FILE
# This launch file loads a saved costmap as a static map for navigation
# and also displays local and global costmaps
...
def generate_launch_description():
    ...
    map_yaml_path = LaunchConfiguration('map_yaml_path', default='')
    
    # Declare launch arguments
    ld.add_action(DeclareLaunchArgument(
        'map_yaml_path',
        default_value='',
        description='Path to the map YAML file (required)'
    ))
    
    # Create message to indicate this is static map mode
    info_msg = LogInfo(
        msg="\n\n" + 
            "********************************************************\n" +
            "*** STATIC MAP NAVIGATION MODE                       ***\n" +
            "*** This launch file loads a saved costmap as a      ***\n" +
            "*** static map for autonomous navigation             ***\n" +
            "********************************************************\n\n"
    )
    ...
    # 4. Local costmap generator - real data only
    ...
    # 9. RViz with custom configuration - showing map and costmaps
